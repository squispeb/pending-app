...
export const env = createEnv({
  server: {
    ...
    VOICE_INTENT_CLASSIFIER_API_URL: z.string().url().optional(),
    VOICE_INTENT_CLASSIFIER_API_KEY: z.string().optional(),
    VOICE_INTENT_CLASSIFIER_MODEL: z.string().optional(),
    VOICE_INTENT_CLASSIFIER_TIMEOUT_MS: z.coerce.number().int().positive().max(30000).default(8000),
  ...
  runtimeEnv: {
    ...
    VOICE_INTENT_CLASSIFIER_API_URL: process.env.VOICE_INTENT_CLASSIFIER_API_URL,
    VOICE_INTENT_CLASSIFIER_API_KEY: process.env.VOICE_INTENT_CLASSIFIER_API_KEY,
    VOICE_INTENT_CLASSIFIER_MODEL: process.env.VOICE_INTENT_CLASSIFIER_MODEL,
    VOICE_INTENT_CLASSIFIER_TIMEOUT_MS: process.env.VOICE_INTENT_CLASSIFIER_TIMEOUT_MS,
